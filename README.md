...
Explication: crée + démarre un conteneur à partir de l’image nginx ,mode détaché (en arrière-plan),redirige le port 8080 de la machine vers le port 80 du conteneur (HTTP),donne un nom au conteneu.  
